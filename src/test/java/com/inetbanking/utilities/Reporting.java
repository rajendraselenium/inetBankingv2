...
public class Reporting extends TestListenerAdapter {
	...
	public void onTestFailure(ITestResult tr)
	{
		...
		test.log(Status.FAIL,MarkupHelper.createLabel(tr.getName(),ExtentColor.RED)); // send the FAIL information to the report with RED color highlighted
	...
	//	String screenshotPath=System.getProperty("user.dir")+"\\Screenshots\\"+tr.getName()+".png";
		...
		{
		try {
			//test.log(Status.FAIL,MarkupHelper.createLabel(tr, color)test.addScreenCaptureFromPath(screenshotPath));
